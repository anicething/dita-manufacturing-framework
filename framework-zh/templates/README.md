...
This directory contains DITA XML templates for Chinese documentation. All 12 templates are available directly at this level. English equivalent templates are in `../../framework-en/templates/`.

本目录包含中文 DITA XML 模板，涵盖所有采用的文档类型。12 个模板均直接在此目录下。英文对应模板位于 `../../framework-en/templates/`。
...
英文模板位于 `../../framework-en/templates/`，文件名与此相同。
...
**English authors:** Use templates from `framework-en/templates/`.
...
See `../../framework-en/ARCHITECTURE/04-EXTENDED-TOPIC-TYPES.md` for the rationale behind each type and the decision tree for choosing the correct one.

关于各类型的原理说明以及选择正确类型的决策树，参见 `../ARCHITECTURE/04-EXTENDED-TOPIC-TYPES.md`。
...
- [Framework (English)](../../framework-en/README.md)
- [Framework (Chinese)](../README.md)
- [Examples (English)](../../framework-en/examples/README.md)
- [Examples (Chinese)](../examples/README.md)
